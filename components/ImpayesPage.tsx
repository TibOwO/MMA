...
export default function ImpayesPage() {
  ...
  const loadImpayes = async () => {
    try {
      // L'API filtre déjà selon le rôle : toutes les disciplines pour un
      // admin, uniquement celles qu'il enseigne pour un coach.
      const url = "/api/admin/adhesions/impayes?";
  ...
  const backHref = isAdmin ? "/admin" : "/coach";
  const backLabel = isAdmin ? "← Retour à l'administration" : "← Retour à l'espace coach";
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-indigo-950/40 border border-indigo-800 rounded-2xl p-6">
          ...
          <div className="text-sm text-gray-300 space-y-2">
            ...
            <p>
              <strong className="text-white">Espèces et chèques :</strong> Les échéances en retard sont détectées quotidiennement.
